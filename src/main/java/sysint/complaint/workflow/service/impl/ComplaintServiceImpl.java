...
public class ComplaintServiceImpl implements ComplaintService {
    ...
    public boolean validate(String complaint) {
        String[] badWords = {"4r5e", "5h1t", "5hit", "a55", "anal", "anus", "ar5e", "arrse", "arse", "ass",
                ...
                "niggah", "niggas", "niggaz", "nigger", "niggers", "nob", "nob jokey", "nobhead", "nobjocky", "nobjokey",
        ...
        for (String bw : badWords
            ...
            int indexOfBadWord = complaint.indexOf(bw);
            if (indexOfBadWord > -1) {
                return false;
            }
        }
